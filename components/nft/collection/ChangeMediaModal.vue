    ...
    async setAudio() {
      ...
      try {
        ...
        if (receipt.status === 1) {
          ...
          try {
            await axios.get('https://api.meownfts.com/endpoints/music-nfts/add?nftAddress='+this.cAddress);
          } catch (e) {
            console.error(e);
          }
    ...
    async setVideo() {
      ...
      try {
        ...
        if (receipt.status === 1) {
          ...
          try {
            await axios.get('https://api.meownfts.com/endpoints/video-nfts/add?nftAddress='+this.cAddress);
          } catch (e) {
            console.error(e);
          }
